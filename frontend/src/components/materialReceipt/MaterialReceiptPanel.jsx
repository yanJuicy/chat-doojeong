...
//
// 문서관리 드로어의 "자재입출고" 탭 안에서 렌더링되는 패널 — DocumentLibraryPanel과
// 동일한 CSS 클래스(upload-drop, document-row 등)를 그대로 재사용한다. 이 프로젝트는
// Tailwind가 아니라 styles.css의 커스텀 클래스 체계를 쓰고 있어서, 새 클래스를 만드는
// 대신 기존 것을 빌려 쓴다.
//
...
export default function MaterialReceiptPanel() {
  ...
  return (
    <section className="material-receipt-panel" aria-labelledby="material-receipt-title">
      <div className="panel-intro">
        <p className="eyebrow">MATERIAL RECEIPT</p>
        <h3 id="material-receipt-title">자재입출고 자동 반영</h3>
